...
getgenv().TimeSkipBranch = "main"
getgenv().gitowner = "ImMejor35"

-- Load main.lua
getgenv().wait = task.wait
loadstring(game:HttpGet("https://github.com/ImMejor35/BloxFruits/raw/refs/heads/".. getgenv().TimeSkipBranch .. "/main.lua"))()

local ImGui = loadstring(game:HttpGet("https://github.com/depthso/Roblox-ImGUI/raw/" .. getgenv().TimeSkipBranch .. "/ImGui.lua"))()
